...
local text = require("external.popups.powermenu.text")

local function create_button(img, hover_img, description, command, hover_color)
	--Imagebox
	local image = wibox.widget {
		widget = wibox.widget.imagebox,
		image = os.getenv("HOME") .. "/.config/awesome/external.popups.powermenu/assets/" .. img .. ".png",
		resize = true,
		opacity = 1,
	}
	...
	buttons:connect_signal("mouse::enter", function()
		...
		image.image = os.getenv("HOME") .. "/.config/awesome/external.popups.powermenu/assets/" .. hover_img .. ".png"
	...
	buttons:connect_signal("mouse::leave", function()
		...
		image.image = os.getenv("HOME") .. "/.config/awesome/external.popups.powermenu/assets/" .. img .. ".png"
		text:set_markup_silently('<span color="' ..
