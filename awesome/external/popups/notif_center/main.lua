...
local header_text = require("external.popups.notif_center.header.header")
local header_buttons = require("external.popups.notif_center.header.button")
				...
				{
					{
						...
						image = os.getenv("HOME") .. '/.config/awesome/external.popups.notif_center/assets/bell.png',
						resize = true,
