...
local icon_path = os.getenv("HOME") .. "/.config/awesome/external.popups.control_center/assets/"

local powermenu = require("external.popups.powermenu.main")
local notif_center = require("external.popups.notif_center.main")
