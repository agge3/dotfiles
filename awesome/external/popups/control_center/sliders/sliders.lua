...
local volume_slider = require("external.popups.control_center.sliders.volume_slider")
local brightness_slider = require("external.popups.control_center.sliders.brightness_slider")
