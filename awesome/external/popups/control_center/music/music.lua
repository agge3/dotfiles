...
local art = wibox.widget {
  image = os.getenv("HOME") .. "/.config/awesome/external.popups.control_center/assets/music.svg",
...
local button = wibox.widget {
  image = os.getenv("HOME") .. "/.config/awesome/external.popups.control_center/assets/pause.png",
  ...
  awful.button({}, 1, function()
    ...
    if is_playing then
      if title_widget.markup == '<span color="' .. color.blueish_white .. '" font="Ubuntu Nerd Font bold 12">' .. "Nothing Playing" .. '</span>' then
        button:set_image(os.getenv("HOME") .. "/.config/awesome/external.popups.control_center/assets/pause.png")
      else
        button:set_image(os.getenv("HOME") .. "/.config/awesome/external.popups.control_center/assets/play.png")
      end
    else
      if title_widget.markup == '<span color="' .. color.blueish_white .. '" font="Ubuntu Nerd Font bold 12">' .. "Nothing Playing" .. '</span>' then
        button:set_image(os.getenv("HOME") .. "/.config/awesome/external.popups.control_center/assets/pause.png")
