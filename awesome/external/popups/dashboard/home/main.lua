...
--Custom Modules
local color = require("external.popups.color")

local header = require("external.popups.dashboard.home.headers")

--Home Widgets
local profile = require("external.popups.dashboard.home.widgets.profile")
local calender = require("external.popups.dashboard.home.widgets.calendar")
local weather = require("external.popups.dashboard.home.widgets.weather")
local launch = require("external.popups.dashboard.home.widgets.quick_launch")
local exit = require("external.popups.dashboard.home.widgets.exit")

--Todo Widgets
local timer = require("external.popups.dashboard.home.todo_widgets.stopwatch")
local todo = require("external.popups.dashboard.home.todo_widgets.todo")
...
--Sidebar
local sidebar = require("external.popups.dashboard.home.sidebar")
